...
If an answer is not correct (or not even a number), prompt the user again, 
allowing the user up to 2 tries in total for that problem. 
If the user has still not answered correctly after 2 tries, the program should output the correct answer.
